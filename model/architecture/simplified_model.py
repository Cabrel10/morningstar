...
def build_simplified_model(
    ...
    x_tech = Dense(32, activation='relu', kernel_regularizer=regularizers.l2(l2_reg), name='tech_dense')(technical_input)
    if use_batch_norm:
    ...
    x_instrument = Embedding(instrument_vocab_size, instrument_embedding_dim, name='instrument_embedding')(instrument_input)
